...
Lastly, [unlike ride-sharing](https://eprint.iacr.org/2024/1109.pdf), micromobility is inherently centralized. There is a company that distributes, recharges, and repairs the devices. Users are already placing a tremendous amount of trust in the vendor by assuming that, for instance, [the brakes work properly](https://www.consumerreports.org/product-safety/brake-problems-in-lime-electric-scooters-causing-accidents-and-injuries/).
